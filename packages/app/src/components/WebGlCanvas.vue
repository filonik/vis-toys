...
import useWebGl, { type WebGlResource, type UseWebGlOptions } from '@/composables/useWebGl'
...
successRef.value = useWebGl(canvasRef, props.renderer, props.listeners, props.options)
</script>
