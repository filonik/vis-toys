...
}`,Le=H({__name:"InstancedSimplicialMeshView",setup(De){const q=oe.maybe(ie()),y=O({source:Ue,material:{fill:"#ffffff",stroke:"#888888",strokeWidth:10}}),o=Q(y),T=O(null);let h=null,u=null;const r={valid:!1,onCreate({device:n}){var m;if(console.log("SimplicialMesh::onCreate"),u)return;const e=T.value,t=W(n,(e==null?void 0:e.shape)??null,{shaderLocation:0,stepMode:"vertex",interleave:!0}),i=W(n,(e==null?void 0:e.layer)??null,{shaderLocation:7,stepMode:"instance",interleave:!0}),f=((m=e==null?void 0:e.shape)==null?void 0:m.primitive)??0;u={shapeVertices:t,layerVertices:i,topology:f}},onUpdate(n){var e,t;r.valid||((e=r.onDelete)==null||e.call(r,n),(t=r.onCreate)==null||t.call(r,n),r.valid=!0)},onDelete(n){console.log("SimplicialMesh::onDelete"),u&&(u=null)}},v=le(N),x=S(v.uniforms.uCamera),w=S(v.uniforms.uMaterial),U=S(v.uniforms.uShape),d=S(v.uniforms.uLayer);x.set({transform:g.identity()}),U.set({transform:g.scaling([.1,.1,.1])}),d.set({transform:g.scaling([.5,.5,.5])}),w.set({fill:[1,1,1,1],stroke:[1,1,1,1],strokeWidth:10});const Y=n=>{const e=Math.min(...n);return g.scaling([e/n[0],e/n[1],1])},K={onCreate(n){var V;console.log("InstancedSimplicialMeshView::onCreate");const{device:e,format:t}=n;if(h||((V=r.onCreate)==null||V.call(r,n),!u))return;const{shapeVertices:i,layerVertices:f}=u,m=e.createShaderModule({code:N}),c=e.createBuffer({size:x.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),k=e.createBuffer({size:w.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),b=e.createBuffer({size:U.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),I=e.createBuffer({size:d.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});h=Object.fromEntries(Object.entries(ye).map(([M,C])=>{const _=e.createRenderPipeline({layout:"auto",vertex:{module:m,entryPoint:"vertexMain",buffers:[...i.bufferLayouts,...f.bufferLayouts]},fragment:{module:m,entryPoint:"fragmentMain",targets:[{format:t}]},primitive:{topology:C}}),B=e.createBindGroup({layout:_.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:c}},{binding:1,resource:{buffer:k}},{binding:2,resource:{buffer:b}},{binding:3,resource:{buffer:I}}]});return[M,{pipeline:_,bindGroup:B,camera:c,material:k,shape:b,layer:I}]}))},onRender(n){var B;const{device:e,context:t}=n;if(!h||((B=r.onUpdate)==null||B.call(r,n),!u))return;const{shapeVertices:i,layerVertices:f}=u,m=e.createCommandEncoder(),c=m.beginRenderPass({colorAttachments:[{clearValue:Float32Array.of(0,0,0,0),loadOp:"clear",storeOp:"store",view:t.getCurrentTexture().createView()}]}),{pipeline:k,bindGroup:b,camera:I,material:V,shape:M,layer:C}=h[u.topology];x.set({transform:Y([1920,1080])}),w.set({fill:A(o.material.fill).gl(),stroke:A(o.material.stroke).gl(),strokeWidth:o.material.strokeWidth}),e.queue.writeBuffer(I,0,x.arrayBuffer),e.queue.writeBuffer(V,0,w.arrayBuffer),e.queue.writeBuffer(M,0,U.arrayBuffer),e.queue.writeBuffer(C,0,d.arrayBuffer),c.setPipeline(k),c.setBindGroup(0,b),c.setVertexBuffer(0,i.buffers[0]),c.setVertexBuffer(1,f.buffers[0]),c.setIndexBuffer(i.indexBuffer,i.indexFormat),c.drawIndexed(i.numElements,f.numElements),c.end();const _=m.finish();e.queue.submit([_])},onDelete(n){var e;console.log("InstancedSimplicialMeshView::Delete"),h&&((e=r.onDelete)==null||e.call(r,n),h=null)}},D={down:!1},$=n=>{const e=[0,0,0];switch(n){case"ArrowLeft":e[0]-=1;break;case"ArrowUp":e[1]+=1;break;case"ArrowRight":e[0]+=1;break;case"ArrowDown":e[1]-=1;break}return e},j={keydown:n=>{console.log(n)},keyup:n=>{const e=$(n.key),t=n.shiftKey?.5:.05;g.translate(d.views.transform,[e[0]*t,e[1]*t,e[2]*t],d.views.transform)},pointerdown:n=>{D.down=!0,n.target.setPointerCapture(n.pointerId)},pointermove:n=>{if(!D.down)return;const e=n.target,t=[e.width,e.height],i=Math.min(...t),f=[+n.movementX*4/i,-n.movementY*4/i,0];g.translate(d.views.transform,[f[0],f[1],f[2]],d.views.transform)},pointerup:n=>{D.down=!1},wheel:n=>{const e=1+n.deltaY/100;g.scale(d.views.transform,[e,e,1],d.views.transform)}},J={alphaMode:"premultiplied",autoResize:!1},F=n=>{try{const e=q(n.source);T.value=ge.parse(e),r.valid=!1}catch(e){if(e instanceof SyntaxError)console.error(e.message);else if(e instanceof he)for(let t of e.issues)console.error(t.message);else throw e}},X=n=>{switch(n.key){case"Enter":return n.shiftKey;case"s":case"S":return n.ctrlKey||n.metaKey;default:return!1}};return Z(document,"keydown",n=>{X(n)&&(n.stopPropagation(),n.preventDefault(),F(o))}),ee(y,F,{immediate:!0}),(n,e)=>(R(),ne(te,null,[s("header",ve,[xe,we,l(fe,{modelValue:y.value,"onUpdate:modelValue":e[0]||(e[0]=t=>y.value=t)},null,8,["modelValue"]),l(ce)]),l(a(pe),{as:"main",class:"flex-grow flex flex-col overflow-hidden","default-index":2},{default:p(()=>[l(a(ue),{class:"flex flex-row md:hidden"},{default:p(()=>[l(a(G),{class:"tab"},{default:p(()=>[E("Input")]),_:1}),l(a(G),{class:"tab"},{default:p(()=>[E("Output")]),_:1})]),_:1}),l(a(de),{class:"h-full md:grid md:grid-cols-2 border-y-2 border-border"},{default:p(()=>[l(a(z),{class:"h-full ui-not-selected:hidden md:ui-not-selected:grid grid grid-rows-1",static:!0},{default:p(()=>[l(se,{modelValue:a(o).source,"onUpdate:modelValue":e[1]||(e[1]=t=>a(o).source=t)},null,8,["modelValue"])]),_:1}),l(a(z),{class:"h-full ui-not-selected:hidden md:ui-not-selected:grid grid grid-rows-2",static:!0},{default:p(()=>[(R(),re(ae,null,{default:p(()=>[l(me,{class:"h-full w-full object-cover",renderer:K,listeners:j,options:J})]),_:1})),s("div",null,[ke,s("div",be,[Ie,P(s("input",{class:"w-16",name:"fill",type:"color","onUpdate:modelValue":e[2]||(e[2]=t=>a(o).material.fill=t)},null,512),[[L,a(o).material.fill]])]),s("div",Ve,[_e,P(s("input",{class:"w-16",name:"stroke",type:"color","onUpdate:modelValue":e[3]||(e[3]=t=>a(o).material.stroke=t)},null,512),[[L,a(o).material.stroke]])]),s("div",Be,[Se,P(s("input",{class:"w-16",name:"strokeWidth",type:"number","onUpdate:modelValue":e[4]||(e[4]=t=>a(o).material.strokeWidth=t)},null,512),[[L,a(o).material.strokeWidth]])])])]),_:1})]),_:1})]),_:1})],64))}});export{Le as default};
