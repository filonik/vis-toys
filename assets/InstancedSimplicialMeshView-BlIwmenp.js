import{d as Z,r as R,q as ee,e as ne,f as s,g as l,k as p,u as a,F as te,b as z,l as G,s as re,S as ae,m as T,v as F,x as se,y as oe}from"./index-DPoGpCrM.js";import{D as ie,E as le,t as fe,n as ce,p as ue,q as de,x as me,y as W,I as pe,z as A,B as ge}from"./ToggleDarkButton.vue_vue_type_script_setup_true_lang-C0swAkkG.js";import{_ as he,b as ye,P as ve,c as q,a as xe}from"./meshes-EwFO3dH4.js";import{m as we,a as D,_ as be,b as N}from"./webgpu-utils.module-7vr2eS4H.js";import{m as g,_ as ke}from"./_plugin-vue_export-helper-DPM3P_dG.js";const Y=`struct VertexIn {
...
}`,Te=Z({__name:"InstancedSimplicialMeshView",setup(v){const K=ie.maybe(le()),x=R({source:Le,material:{fill:"#ffffff",stroke:"#888888",strokeWidth:10}}),o=fe(x),E=R(null);let h=null,u=null;const r={valid:!1,onCreate({device:n}){var m;if(console.log("SimplicialMesh::onCreate"),u)return;const e=E.value,t=q(n,(e==null?void 0:e.shape)??null,{shaderLocation:0,stepMode:"vertex",interleave:!0}),i=q(n,(e==null?void 0:e.layer)??null,{shaderLocation:7,stepMode:"instance",interleave:!0}),f=((m=e==null?void 0:e.shape)==null?void 0:m.primitive)??0;u={shapeVertices:t,layerVertices:i,topology:f}},onUpdate(n){var e,t;r.valid||((e=r.onDelete)==null||e.call(r,n),(t=r.onCreate)==null||t.call(r,n),r.valid=!0)},onDelete(n){console.log("SimplicialMesh::onDelete"),u&&(u=null)}},w=we(Y),b=D(w.uniforms.uCamera),k=D(w.uniforms.uMaterial),M=D(w.uniforms.uShape),d=D(w.uniforms.uLayer);b.set({transform:g.identity()}),M.set({transform:g.scaling([.1,.1,.1])}),d.set({transform:g.scaling([.5,.5,.5])}),k.set({fill:[1,1,1,1],stroke:[1,1,1,1],strokeWidth:10});const $=n=>{const e=Math.min(...n);return g.scaling([e/n[0],e/n[1],1])},j={onCreate(n){var S;console.log("InstancedSimplicialMeshView::onCreate");const{device:e,format:t}=n;if(h||((S=r.onCreate)==null||S.call(r,n),!u))return;const{shapeVertices:i,layerVertices:f}=u,m=e.createShaderModule({code:Y}),c=e.createBuffer({size:b.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),I=e.createBuffer({size:k.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),_=e.createBuffer({size:M.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),V=e.createBuffer({size:d.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});h=Object.fromEntries(Object.entries(xe).map(([P,L])=>{const B=e.createRenderPipeline({layout:"auto",vertex:{module:m,entryPoint:"vertexMain",buffers:[...i.bufferLayouts,...f.bufferLayouts]},fragment:{module:m,entryPoint:"fragmentMain",targets:[{format:t}]},primitive:{topology:L}}),U=e.createBindGroup({layout:B.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:c}},{binding:1,resource:{buffer:I}},{binding:2,resource:{buffer:_}},{binding:3,resource:{buffer:V}}]});return[P,{pipeline:B,bindGroup:U,camera:c,material:I,shape:_,layer:V}]}))},onRender(n){var U;const{device:e,context:t}=n;if(!h||((U=r.onUpdate)==null||U.call(r,n),!u))return;const{shapeVertices:i,layerVertices:f}=u,m=e.createCommandEncoder(),c=m.beginRenderPass({colorAttachments:[{clearValue:Float32Array.of(0,0,0,0),loadOp:"clear",storeOp:"store",view:t.getCurrentTexture().createView()}]}),{pipeline:I,bindGroup:_,camera:V,material:S,shape:P,layer:L}=h[u.topology];b.set({transform:$([1920,1080])}),k.set({fill:N(o.material.fill).gl(),stroke:N(o.material.stroke).gl(),strokeWidth:o.material.strokeWidth}),e.queue.writeBuffer(V,0,b.arrayBuffer),e.queue.writeBuffer(S,0,k.arrayBuffer),e.queue.writeBuffer(P,0,M.arrayBuffer),e.queue.writeBuffer(L,0,d.arrayBuffer),c.setPipeline(I),c.setBindGroup(0,_),c.setVertexBuffer(0,i.buffers[0]),c.setVertexBuffer(1,f.buffers[0]),c.setIndexBuffer(i.indexBuffer,i.indexFormat),c.drawIndexed(i.numElements,f.numElements),c.end();const B=m.finish();e.queue.submit([B])},onDelete(n){var e;console.log("InstancedSimplicialMeshView::Delete"),h&&((e=r.onDelete)==null||e.call(r,n),h=null)}},C={down:!1},J=n=>{const e=[0,0,0];switch(n){case"ArrowLeft":e[0]-=1;break;case"ArrowUp":e[1]+=1;break;case"ArrowRight":e[0]+=1;break;case"ArrowDown":e[1]-=1;break}return e},X={keydown:n=>{console.log(n)},keyup:n=>{const e=J(n.key),t=n.shiftKey?.5:.05;g.translate(d.views.transform,[e[0]*t,e[1]*t,e[2]*t],d.views.transform)},pointerdown:n=>{C.down=!0,n.target.setPointerCapture(n.pointerId)},pointermove:n=>{if(!C.down)return;const e=n.target,t=[e.width,e.height],i=Math.min(...t),f=[+n.movementX*4/i,-n.movementY*4/i,0];g.translate(d.views.transform,[f[0],f[1],f[2]],d.views.transform)},pointerup:n=>{C.down=!1},wheel:n=>{const e=1+n.deltaY/100;g.scale(d.views.transform,[e,e,1],d.views.transform)}},H={alphaMode:"premultiplied",autoResize:!1},O=n=>{try{const e=K(n.source);E.value=ye.parse(e),r.valid=!1}catch(e){if(e instanceof SyntaxError)console.error(e.message);else if(e instanceof ve)for(let t of e.issues)console.error(t.message);else throw e}},Q=n=>{switch(n.key){case"Enter":return n.shiftKey;case"s":case"S":return n.ctrlKey||n.metaKey;default:return!1}};return ce(document,"keydown",n=>{Q(n)&&(n.stopPropagation(),n.preventDefault(),O(o))}),ee(x,O,{immediate:!0}),(n,e)=>(z(),ne(te,null,[s("header",Ie,[_e,Ve,l(ue,{modelValue:x.value,"onUpdate:modelValue":e[0]||(e[0]=t=>x.value=t)},null,8,["modelValue"]),l(de)]),l(a(ge),{as:"main",class:"flex-grow flex flex-col overflow-hidden","default-index":2},{default:p(()=>[l(a(me),{class:"flex flex-row md:hidden"},{default:p(()=>[l(a(W),{class:"tab"},{default:p(()=>[G("Input")]),_:1}),l(a(W),{class:"tab"},{default:p(()=>[G("Output")]),_:1})]),_:1}),l(a(pe),{class:"h-full md:grid md:grid-cols-2 border-y-2 border-border"},{default:p(()=>[l(a(A),{class:"h-full ui-not-selected:hidden md:ui-not-selected:grid grid grid-rows-1",static:!0},{default:p(()=>[l(he,{modelValue:a(o).source,"onUpdate:modelValue":e[1]||(e[1]=t=>a(o).source=t)},null,8,["modelValue"])]),_:1}),l(a(A),{class:"h-full ui-not-selected:hidden md:ui-not-selected:grid grid grid-rows-2",static:!0},{default:p(()=>[(z(),re(ae,null,{default:p(()=>[l(be,{class:"h-full w-full object-cover show-focus",renderer:j,listeners:X,options:H})]),_:1})),s("div",null,[Se,s("div",Be,[Ue,T(s("input",{class:"w-16",name:"fill",type:"color","onUpdate:modelValue":e[2]||(e[2]=t=>a(o).material.fill=t)},null,512),[[F,a(o).material.fill]])]),s("div",De,[Me,T(s("input",{class:"w-16",name:"stroke",type:"color","onUpdate:modelValue":e[3]||(e[3]=t=>a(o).material.stroke=t)},null,512),[[F,a(o).material.stroke]])]),s("div",Ce,[Pe,T(s("input",{class:"w-16",name:"strokeWidth",type:"number","onUpdate:modelValue":e[4]||(e[4]=t=>a(o).material.strokeWidth=t)},null,512),[[F,a(o).material.strokeWidth]])])])]),_:1})]),_:1})]),_:1})],64))}}),Ge=ke(Te,[["__scopeId","data-v-186cab30"]]);export{Ge as default};
